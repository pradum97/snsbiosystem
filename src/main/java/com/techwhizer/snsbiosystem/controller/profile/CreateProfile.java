...
import com.techwhizer.snsbiosystem.model.CreateUsersResponse;
import com.techwhizer.snsbiosystem.model.UpdateUserResponse;
...
public class CreateProfile implements Initializable {
    ...
    private void setTextFieldData(User userDTO) {
        ...
        String currentUsername = userDTO.getRequestedLoginName();
        if (signedUsername.equals(currentUsername)) {
            roleContainer.setDisable(true);
        }
    ...
    class RoleConfigModel {
        ...
        private boolean admin, doctor, patient, dealer;
    ...
    public void submitBnClick(ActionEvent event) {
        ...
        alert.setHeaderText("Please check, is all the information correct?");
