...
public class PreviewKitUsages implements Initializable {
    ...
    public TableColumn<KitUsageDTO, String> colStatus;
    ...
    private ObservableList<KitUsageDTO> kitsList = FXCollections.observableArrayList();
    ...
    private void createMultipleKItsUsage(String json) {
        ...
        try {
            ...
            if (resEntity != null) {
                ...
                List<KitUsageDTO> failed = asr.getInvalidKits();
                List<KitUsageDTO> added = asr.getAdded();
    ...
    private void sendRequest() {
        ...
        try {
            HttpClient httpClient = HttpClients.createDefault();
            HttpPost httpPost = new HttpPost(UrlConfig.getKitsUsagesPreviewUrl());
            httpPost.addHeader("Cookie", (String) Login.authInfo.get("token"));
    ...
    private void changeTableView(int index, int limit) {
        ...
        SortedList<KitUsageDTO> sortedData = new SortedList<>(
    ...
    private void setOptionalCell() {
        colStatus.setCellFactory((TableColumn<KitUsageDTO, String> param) -> new TableCell<>() {
            @Override
            public void updateItem(String item, boolean empty) {
                ...
                if (empty) {
                    ...
                    KitUsageDTO user = tableview.getItems().get(getIndex());
            ...
            public void updateItem(String item, boolean empty) {
                ...
                if (empty) {
                    ...
                    if (null != String.valueOf(kd.getId())) {
                        ...
                        if (!String.valueOf(txt).isEmpty() && !Objects.equals(txt, "null")) {
        ...
        colTestDate.setCellFactory((TableColumn<KitUsageDTO, String> param) -> new TableCell<>() {
            ...
            public void updateItem(String item, boolean empty) {
                ...
                if (empty) {
                    ...
                    if (null != kd.getTestDate() && !String.valueOf(kd.getTestDate()).isEmpty()) {
