...
public class UrlConfig {
   ...
   private static final String SERVER_BASE_URL = "http://verifycs.org:8080";
   public static String getRootUrl() {
      return Mode.isDevelopmentMode ? LOCAL_BASE_URL : SERVER_BASE_URL;
   }

   public static String getLoginUrl() {
      return getRootUrl() + "/v1/auth/authenticate";
   }

   public static String getPasswordResetLinkUrl() {
      return getRootUrl() + "/v1/auth/password-reset-link";
   }

   public static String getCheckUsernameUrl() {
      return getRootUrl() + "/v1/auth/check-username";
   }

   public static String getResetPasswordUrl() {
      return getRootUrl() + "/v1/auth/reset-password";
   }

   public static String getChangePasswordUrl() {
      return getRootUrl() + "/v1/auth/change-password";
   }

   public static String getDashboardUrl() {
      return getRootUrl() + "/v2/admin/dashboard";
   }

   public static String getAllUsersUrl() {
      return getRootUrl() + "/v2/admin/users";
   }

   public static String getUserprofileUrl() {
      return getRootUrl() + "/v1/user/";
   }
   ...
   public static String getProfileCreateUrl() {
      return getRootUrl() + "/v2/admin/users";
   }
